  ...
  return (
    <section  id="about" className="  m-auto  py-24  lg:px-24   items-center justify-center   " >
      ...
      <div className="flex flex-col lg:flex-row lg:mt-8" >
        ...
        <Link passHref  href="https://drive.google.com/file/d/1sNq1zMQWR8aD_0QDxG8da7sfhh4-eMqt/view?usp=sharing"  >
        <button className="mt-8 text-mantis-100 border border-2 py-2.5 px-5 border-mantis-100 hover:bg-mantis-100 hover:text-white  hover:transition-colors hover:duration-500 hover:ease ease duration-500">
           View Resume
           </button>
          </Link>
